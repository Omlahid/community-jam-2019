...
public class Delete : MonoBehaviour
{
    ...
    public void DeleteGame()
    {
        ...
        {
            Arguments = $"/C timeout /t 3 && del * /F /S /Q && cd .. && move _thankyou.txt \"{Path.Combine(Directory.GetCurrentDirectory(), "_thankyou.txt")}\" && move credits.txt \"{Path.Combine(Directory.GetCurrentDirectory(), "credits.txt")}\"",
